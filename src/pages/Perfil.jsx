    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--color-bg-secondary)] border border-[var(--color-accent)] rounded-2xl p-6 shadow-lg">
          ...
          <button className="w-full py-3 border border-dashed border-[var(--color-accent)] rounded-lg text-[var(--color-highlight)] hover:bg-[var(--color-bg-primary)] transition-colors flex items-center justify-center gap-2 text-sm font-medium">
            <Plus size={16} />
            Adicionar nova rota
          </button>
        </div>
        ...
        <div className="bg-[var(--color-bg-secondary)] border border-[var(--color-accent)] rounded-2xl p-6 shadow-lg">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue={user?.name} className="w-full bg-[var(--color-bg-primary)] border border-[var(--color-accent)] text-white text-sm rounded-lg px-3 py-2 focus:outline-none focus:border-[var(--color-highlight)]" />
            </div>
            <div>
              <label className="block text-sm text-gray-400 mb-1">Cidade Principal</label>
              <input type="text" defaultValue="São Paulo, SP" className="w-full bg-[var(--color-bg-primary)] border border-[var(--color-accent)] text-white text-sm rounded-lg px-3 py-2 focus:outline-none focus:border-[var(--color-highlight)]" />
            </div>
            <div>
              <label className="block text-sm text-gray-400 mb-1">Modal Preferido</label>
              <select className="w-full bg-[var(--color-bg-primary)] border border-[var(--color-accent)] text-white text-sm rounded-lg px-3 py-2 focus:outline-none focus:border-[var(--color-highlight)]">
                <option>Carro</option>
            ...
            <button type="button" className="px-4 py-2 bg-[var(--color-accent)] text-white rounded-lg text-sm font-medium hover:bg-opacity-80 transition-colors">
              Salvar alterações
            </button>
          </form>
        </div>
